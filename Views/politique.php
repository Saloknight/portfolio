<section class="politique-content">
    <div class="container">
        ...
        <p>La présente politique de confidentialité, désignée ci-après la <strong>« Politique »</strong>, expose mes pratiques concernant les informations que je peux collecter sur le Site et leur utilisation.</p>
        ...
        <p>
            <strong>Nicolas Martins</strong><br>
            nicolas.martins1912@gmail.com
        </p>
        ...
        <p>Je peux être amené à divulguer les Données personnelles aux autorités judiciaires, aux forces de l’ordre ou à toute autre authority lorsque cela est requis par la loi.</p>
        ...
        <h2>SÉCURITÉ</h2>
        <p>La sécurité de vos Données personnelles est très importante pour moi. Les données personnelles recueillies sur le site sont traitées selon des protocoles sécurisés qui limitent considérablement les risques d’interception ou de récupération par des tiers.</p>
        ...
        <a href="<?= homeUrl()?>Contact" class="back-link">Retour au Site</a>
    </div>
</section>